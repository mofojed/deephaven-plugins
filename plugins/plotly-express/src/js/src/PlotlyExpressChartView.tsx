...
/**
 * Lazy-loaded view for the Plotly Express widget plugin. This module statically
 * imports the heavy `Chart` component and `Plotly` runtime so they are emitted
 * into a separate chunk that is only fetched when the first chart is rendered.
 */
export function PlotlyExpressChartView(
...
export default PlotlyExpressChartView;
