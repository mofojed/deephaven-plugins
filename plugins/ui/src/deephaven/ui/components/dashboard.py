...
def dashboard(
    ...
    Args:
        ...
        show_close_icon: Whether to show close icons on the dashboard panels. Defaults to False.
    ...
    return DashboardElement(
        element, show_close_icon=show_close_icon, show_headers=show_headers
    )
