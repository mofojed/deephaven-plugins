...
from deephaven.ui._internal import EventContext


class ToneTestCase(unittest.TestCase):
    """Tests for the tone API."""
    ...
    def test_sends_tone_event(self):
        ...
        self.assertEqual(name, "deephaven_plugin_tone.event")
    ...
    def test_rejects_invalid_waveform(self):
        from deephaven_plugin_tone import tone, ToneException
