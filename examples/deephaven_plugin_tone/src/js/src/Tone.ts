...
// Must match the event name sent by `tone` in tone.py, namespaced with the
// package namespace to avoid collisions with other plugins.
export const TONE_EVENT = 'deephaven_plugin_tone.event';
